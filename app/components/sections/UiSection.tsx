...
export default function UiSection() {
  ...
  return (
    <Section
      id="ui"
      title="App Interface"
      className="bg-[var(--background)] py-12 md:py-16"
      fullHeight={false}
    >
      {/* Introduction */}
      ...
      <div className="mt-10 grid md:grid-cols-3 gap-6">
        <div className="text-center">
          <h4 className="font-semibold text-white mb-2">Clean Design</h4>
          <p className="text-gray-300">
            Modern, intuitive interface that's easy to navigate
          </p>
        </div>
        <div className="text-center">
          <h4 className="font-semibold text-white mb-2">Fast Performance</h4>
          <p className="text-gray-300">
            Smooth animations and quick loading times
          </p>
        </div>
        <div className="text-center">
          <h4 className="font-semibold text-white mb-2">Beautiful Visuals</h4>
          <p className="text-gray-300">
